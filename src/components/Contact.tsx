          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-portfolio-neutral-500 dark:text-gray-300">nurulain.afiqah@hotmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-portfolio-neutral-500 dark:text-gray-300">+60-1162688478</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/NurulainAfiqah" target="_blank" rel="noopener noreferrer" className="bg-portfolio-neutral-100 dark:bg-gray-800 p-4 rounded-full transition-colors hover:bg-portfolio-purple-100 dark:hover:bg-gray-700">
                ...
                <a href="https://www.linkedin.com/in/nurulain-afiqah-abdullah/" target="_blank" rel="noopener noreferrer" className="bg-portfolio-neutral-100 dark:bg-gray-800 p-4 rounded-full transition-colors hover:bg-portfolio-purple-100 dark:hover:bg-gray-700">
                  <svg className="h-6 w-6 text-portfolio-neutral-600 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
